...
public class CoreOfTheSeaLivingEntityIsHitWithItemProcedure {

	public static void execute(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PoseidonsGateMainModMod.LOGGER.warn("Failed to load dependency entity for procedure CoreOfTheSeaLivingEntityIsHitWithItem!");
			return;
		}
